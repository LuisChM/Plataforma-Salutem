            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                {{-- <div class="form-group">
                    ...
                    <input id="surname" type="text"
                        class="form-control border-0 bg-light shadow-sm @error('surname') is-invalid @enderror" name="surname"
                ...
                <div class="form-group">
                    ...
                    <input id="telephone" type="number"
                        class="form-control border-0 bg-light shadow-sm @error('telephone') is-invalid @enderror" name="telephone"
