                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" action="{{ url('productos/' . $producto->id) }}">
                                    ...
                                    <a href="{{ url('productos/' . $producto->id . '/edit') }}"><img
                                            src="/img/seleccionar.svg" class="iconoAccion" alt="seleccionar"></a>

                                    <form method="Post" action="{{ route('productos.destroy', $productos) }}">
                                        @csrf @method('delete')
                                        <button class="bg-transparent border-0" type="submit"
                                            onclick="return confirm('Esta seguro de eliminar el dato');"><img
