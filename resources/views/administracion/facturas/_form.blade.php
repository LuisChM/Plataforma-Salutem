@csrf
                    ...
                    <div class="form-group ">
                        ...
                        <div class="d-flex align-items-center ">
                            <input type="date" class="form-control col-lg-4 col-lg-4 col-md-4 @error('fecha') is-invalid @else border-0 @enderror" name="fecha" id="fecha"
                    ...
                    <div class="form-group ">
                        ...
                        <div class="d-flex align-items-center ">
                            <input type="number" class="form-control col-lg-4 col-md-4 @error('total') is-invalid @else border-0 @enderror" name="total" id="total"
